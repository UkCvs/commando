...
void CThemes::getColors(CConfigFile &configfile)
{
	...
	g_settings.menu_Head_green = configfile.getInt32( "menu_Head_green", 0x00 );
	g_settings.menu_Head_blue = configfile.getInt32( "menu_Head_blue", 0x28 );
	...
	g_settings.menu_Content_green = configfile.getInt32( "menu_Content_green", 0x00 );
	g_settings.menu_Content_blue = configfile.getInt32( "menu_Content_blue", 0x28 );
	...
	g_settings.menu_Content_inactive_green = configfile.getInt32( "menu_Content_inactive_green", 0x00 );
	g_settings.menu_Content_inactive_blue = configfile.getInt32( "menu_Content_inactive_blue", 0x28 );
	g_settings.menu_Content_inactive_Text_alpha = configfile.getInt32( "menu_Content_inactive_Text_alpha", 0x00 );
	g_settings.menu_Content_inactive_Text_red = configfile.getInt32( "menu_Content_inactive_Text_red", 0x3C );
	g_settings.menu_Content_inactive_Text_green = configfile.getInt32( "menu_Content_inactive_Text_green", 0x3C );
	g_settings.menu_Content_inactive_Text_blue = configfile.getInt32( "menu_Content_inactive_Text_blue", 0x3C );
	...
	g_settings.infobar_blue = configfile.getInt32( "infobar_blue", 0x28 );
