...
class CStringInputSMS : public CStringInput
{
	...
	public:
		CStringInputSMS(const neutrino_locale_t Name, char* Value, int Size, const neutrino_locale_t Hint_1 = NONEXISTANT_LOCALE, const neutrino_locale_t Hint_2 = NONEXISTANT_LOCALE, const char * const Valid_Chars = "abcdefghijklmnopqrstuvwxyz0123456789. ", CChangeObserver* Observ = NULL, const char * const Icon = NULL);
		CStringInputSMS(const neutrino_locale_t Name, std::string* Value, int Size, bool ValueIsUtf8 = false, const neutrino_locale_t Hint_1 = NONEXISTANT_LOCALE, const neutrino_locale_t Hint_2 = NONEXISTANT_LOCALE, const char * const Valid_Chars = "abcdefghijklmnopqrstuvwxyz0123456789. ", CChangeObserver* Observ = NULL, const char * const Icon = NULL);
};
...
class CPINInput : public CStringInput
{
	protected:
		virtual void paintChar(int pos);
	public:
		CPINInput(const neutrino_locale_t Name, char* Value, int Size, const neutrino_locale_t Hint_1 = NONEXISTANT_LOCALE, const neutrino_locale_t Hint_2 = NONEXISTANT_LOCALE, const char * const Valid_Chars = "0123456789", CChangeObserver* Observ = NULL)
...
{
	public:
		CPINChangeWidget(const neutrino_locale_t Name, char* Value, int Size, const neutrino_locale_t Hint_1 = NONEXISTANT_LOCALE, const char * const Valid_Chars = "0123456789", CChangeObserver* Observ = NULL)
